...
module.exports.config = {
  ...
  module.exports.run = async function({ api, event, args, Currencies, getText, permssion }) {
    try {
      ...
      // sendMessage
      api.sendMessage({
        body: '🌺𝑷𝒉𝒆́𝒑 𝑻𝒉𝒖𝒂̣̂𝒕 𝑾𝒊𝒏𝒙 𝑬𝒏𝑪𝒉𝒂𝒏𝑻𝒊𝒙...𝑪𝒉𝒐̛̀ 𝑩𝒐𝒕 𝑳𝒂̆́𝒄 𝑵𝒉𝒆́\n🌺𝑪𝒉𝒖́𝒄 𝑩𝒂̣𝒏 𝑴𝒂𝒚 𝑴𝒂̆́𝒏...💝',
        ...
        setTimeout(() => {
          ...
          if (check >= 0 || check2 == true) {
            return api.sendMessage({
              body: `➢ 𝑳𝒂̆́𝒄 𝑻𝒓𝒖́𝒏𝒈: ${icon1} | ${icon2} | ${icon3}\n🌺𝑩𝒂̣𝒏 𝑻𝒉𝒂̆́𝒏𝒈 𝑳𝒐̛́𝒏 𝑽𝒂̀ 𝑵𝒉𝒂̣̂𝒏 𝑽𝒆̂̀ 𝑺𝒐̂́ 𝑻𝒊𝒆̂̀𝒏 💵 ${moneyBet * 3}$`,
              attachment: listimg
            }, threadID, () => Currencies.increaseMoney(senderID, moneyBet * 3), messageID);
          }
          else if (check < 0 || check2 == false) {
            return api.sendMessage({
              body: `➢ 𝑳𝒂̆́𝒄 𝑻𝒓𝒖́𝒏𝒈: ${icon1} | ${icon2} | ${icon3}\n🌺𝑩𝒂̣𝒏 𝑻𝒉𝒖𝒂 𝑹𝒐̂̀𝒊 𝑽𝒂̀ 𝑩𝒊̣ 𝑻𝒓𝒖̛̀ 💸 ${moneyBet}$`,
              attachment: listimg
