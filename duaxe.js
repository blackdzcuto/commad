...
module.exports.languages = {
	"vi": {
		"carHelp": "=====『 𝐆𝐀𝐌𝐄 Đ𝐔𝐀 𝐗𝐄 』=====\n\n♚─────────♔─────────────♚\n==『 𝙃𝙐̛𝙊̛́𝙉𝙂 𝘿𝘼̂̃𝙉 𝙎𝙐̛̉ 𝘿𝙐̣𝙉𝙂 』==\n\n» 𝘿𝙪𝙖𝙭𝙚 𝙞𝙣𝙛𝙤 / 𝙭𝙚𝙢 𝙩𝙝𝙤̂𝙣𝙜 𝙩𝙞𝙣 𝙭𝙚 𝙘𝙪̉𝙖 𝙗𝙖̣𝙣\n» 𝘿𝙪𝙖𝙭𝙚 𝙨𝙝𝙤𝙥 / 𝙨𝙝𝙤𝙥 𝙢𝙪𝙖 𝙭𝙚\n» 𝘿𝙪𝙖𝙭𝙚 𝙘𝙧𝙚𝙖𝙩𝙚 [ 𝙨𝙤̂́ 𝙩𝙞𝙚̂̀𝙣 𝙘𝙪̛𝙤̛̣𝙘 ] / 𝙙𝙚̂̉ 𝙙𝙪𝙖 𝙭𝙚\n» 𝘿𝙪𝙖𝙭𝙚 𝙪𝙥𝙙𝙖𝙩𝙚 / 𝙣𝙖̂𝙣𝙜 𝙘𝙖̂́𝙥 𝙭𝙚\n» 𝘿𝙪𝙖𝙭𝙚 𝙩𝙤𝙥 / 𝙭𝙚𝙢 𝙩𝙤𝙥 𝙨𝙚𝙧𝙫𝙚𝙧",
		"noBets": "𝘽𝙖̣𝙣 𝙘𝙝𝙪̛𝙖 𝙣𝙝𝙖̣̂𝙥 𝙩𝙞𝙚̂̀𝙣 𝙙𝙖̣̆𝙩 𝙘𝙪̛𝙤̛̣𝙘",
		"fail": "Chỉ chọn %1 -> %2",
...
module.exports.run = async ({ api, event, args, Users, Currencies, getText }) => {
	...
	switch (args[0]) {
        ...
        let name = await Users.getNameUser(userWin[0])
				fs.writeFileSync(pathData, JSON.stringify(data, null, 4));
				let result = `====『 𝙆𝙀̂́𝙏 𝙌𝙐𝘼̉ 𝘾𝙐𝙊̣̂𝘾 𝘿𝙐𝘼 』====\n\n──────────────\n===『 𝘿𝙖𝙣𝙝 𝙨𝙖́𝙘𝙝 𝙘𝙪𝙤̣̂𝙘 𝙙𝙪𝙖 』===\n» Top 1: ${name} \nNhận được ${global.client.duaxe[threadID].money * 2} đô \n\n`;
				let e = 1;
      ...
      return api.sendMessage({body: "===『 𝐆𝐀𝐌𝐄 Đ𝐔𝐀 𝐗𝐄 』===\n\n♚─────────♔──────────♚\n» 𝘿𝙪𝙖𝙭𝙚 𝙞𝙣𝙛𝙤 / 𝙭𝙚𝙢 𝙩𝙝𝙤̂𝙣𝙜 𝙩𝙞𝙣 𝙭𝙚 𝙘𝙪̉𝙖 𝙗𝙖̣𝙣\n» 𝘿𝙪𝙖𝙭𝙚 𝙨𝙝𝙤𝙥 / 𝙨𝙝𝙤𝙥 𝙢𝙪𝙖 𝙭𝙚\n» 𝘿𝙪𝙖𝙭𝙚 𝙘𝙧𝙚𝙖𝙩𝙚 / 𝙙𝙪𝙖 𝙭𝙚\n» 𝘿𝙪𝙖𝙭𝙚 𝙪𝙥𝙙𝙖𝙩𝙚 / 𝙣𝙖̂𝙣𝙜 𝙘𝙖̂́𝙥 𝙭𝙚\n» 𝘿𝙪𝙖𝙭𝙚 𝙩𝙤𝙥 / 𝙭𝙚𝙢 𝙩𝙤𝙥 𝙨𝙚𝙧𝙫𝙚𝙧 ",attachment: (picture)
